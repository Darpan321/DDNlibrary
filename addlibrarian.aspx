<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="addlibrarian.aspx.cs" Inherits="library.addlibrarian" %>
...
<body style="height:657px; width:1366px;margin:0px;background-image:url('addlibrarian.jpg'); background-repeat:no-repeat; background-size:100% 100%;">
    <form id="form1" runat="server">
      ...
      <asp:Panel ID="Panel1" runat="server" style="position:absolute; top: 121px; left: 74px; width: 417px; height: 437px;border:solid black;">
          <asp:Label ID="Label3" runat="server" Text="ADD LIBRARIAN" style="position:absolute; top: 23px; left: 114px;" Font-Size="X-Large"></asp:Label>
          <asp:Button ID="submitbutton" runat="server" Text="SUBMIT" style="position:absolute; top: 366px; left: 168px; height: 27px;" OnClick="submitbutton_Click" />
            <asp:Label ID="Label4" runat="server" Font-Size="Large" style="position:absolute; top: 87px; left: 60px; right: 225px;" Text="LIBRARIAN ID:"></asp:Label>
          <asp:Label ID="Label5" runat="server" Font-Size="Large" style="position:absolute; top: 137px; left: 59px; right: 197px;" Text="LIBRARIAN NAME:"></asp:Label>
          ...
          <asp:TextBox CssClass="textbox" ID="librarianid" runat="server" style="position:absolute; top: 86px; left: 230px;" ToolTip="Enter Librarian ID"></asp:TextBox>
