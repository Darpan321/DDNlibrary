<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="updatebook.aspx.cs" Inherits="library.updatebook" %>
...
<body style="height:657px; width:1366px;margin:0px;background-image:url('updatebookbackgroundup.png'); background-repeat:no-repeat; background-size:100% 100%;">
    <form id="form1" runat="server">
            <div style="height: 53px;margin-top:0px;margin-bottom:0px;z-index:1000;background: rgba(0, 0, 0, 0.5);position:sticky;">
                ...
                <asp:DropDownList CssClass="dropdownlist1" ID="DropDownList1" runat="server" style="position:absolute; top: 12px; left: 600px; height: 29px; width: 111px; right: 220px;" Font-Size="Large" OnSelectedIndexChanged="DropDownList1_SelectedIndexChanged" AutoPostBack="True">
      ...
      <asp:Panel ID="Panel1" runat="server" style="position:absolute; top: 122px; left: 190px; width: 417px; height: 437px;border:solid black;">
          <asp:Label ID="Label3" runat="server" Text="UPDATE BOOKS" style="position:absolute; top: 24px; left: 124px;" Font-Size="X-Large"></asp:Label>
          <asp:Button ID="submitbutton" runat="server" Text="SUBMIT" style="position:absolute; top: 400px; left: 168px;" OnClick="submitbutton_Click" />
            <asp:Label ID="Label4" runat="server" Font-Size="Large" style="position:absolute; top: 67px; left: 60px; right: 253px;" Text="BOOK ID:"></asp:Label>
          ...
          <asp:TextBox CssClass="textbox" ID="bookid" runat="server" style="position:absolute; top: 66px; left: 230px;" ToolTip="Enter Book ID"></asp:TextBox>
          ...
          <asp:TextBox CssClass="textbox" ID="price" runat="server" style="position:absolute; top: 367px; left: 229px;" ToolTip="Enter Book Type"></asp:TextBox>
            ...
            <asp:Button ID="checkbutton" runat="server" OnClick="checkbutton_Click" style="position:absolute; top: 96px; left: 173px;" Text="CHECK" />
            </asp:Panel>
