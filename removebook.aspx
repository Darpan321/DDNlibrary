...
<body style="height:657px; width:1366px;margin:0px;background-image:url('removebookbackgroundup.png'); background-repeat:no-repeat; background-size:100% 100%;">
    <form id="form1" runat="server">
      ...
      <asp:Panel ID="Panel1" runat="server" style="position:absolute; top: 136px; left: 825px; width: 417px; height: 256px; border:solid black;">
          <asp:Label ID="Label3" runat="server" Text="REMOVE BOOKS" style="color:white;position:absolute; top: 23px; left: 129px;" Font-Size="X-Large"></asp:Label>
          <asp:Button ID="submitbutton" runat="server" Text="SUBMIT" style="position:absolute; top: 185px; left: 168px;" OnClick="submitbutton_Click" />
            <asp:Label ID="Label4" runat="server" Font-Size="Large" style="color:white;position:absolute; top: 87px; left: 60px; right: 253px;" Text="BOOK ID:"></asp:Label>
          <asp:Label ID="Label5" runat="server" Font-Size="Large" style="color:white;position:absolute; top: 137px; left: 59px; right: 227px;" Text="ISBN NUMBER:"></asp:Label>
          <asp:TextBox CssClass="textbox" ID="bookid" runat="server" style="position:absolute; top: 86px; left: 216px;" ToolTip="Enter Book ID"></asp:TextBox>
          <asp:TextBox CssClass="textbox" ID="isbnnumber" runat="server" style="position:absolute; top: 134px; left: 216px;" ToolTip="Enter ISBN number"></asp:TextBox>
