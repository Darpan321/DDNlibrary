<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="issuedbooklistadmin.aspx.cs" Inherits="library.issuedbooklistadmin" %>
...
<body style="height:657px; width:1366px;margin:0px;background-image:url('issuedbooklistadminup.png'); background-repeat:no-repeat; background-size:100% 100%;">
    <form id="form1" runat="server">
            <div style="height: 53px;margin-top:0px;margin-bottom:0px;z-index:1000;background: rgba(0, 0, 0, 0.5);position:sticky;">
                ...
                <asp:DropDownList CssClass="dropdownlist1" ID="DropDownList2" runat="server" style="position:absolute; top: 12px; left: 741px; height: 29px; width: 125px; right: 65px;" Font-Size="Large" OnSelectedIndexChanged="DropDownList2_SelectedIndexChanged" AutoPostBack="True">
            ...
            <asp:Label ID="Label3" runat="server" Text="ISSUED BOOKLIST" style="position:absolute; top: 195px; left: 651px;"></asp:Label>
            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" BackColor="#CCCCCC" BorderColor="#999999" BorderStyle="Solid" BorderWidth="3px" CellPadding="4" CellSpacing="2" DataKeyNames="issueid" DataSourceID="SqlDataSource1" ForeColor="Black" style="position:absolute; top: 247px; left: 393px;">
                <Columns>
