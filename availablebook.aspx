<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="availablebook.aspx.cs" Inherits="library.availablebook" %>
...
<body style="height:657px; width:1366px;margin:0px;background-image:url('allbookup.png'); background-repeat:no-repeat; background-size:100% 100%;">
    <form id="form1" runat="server">
            ...
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:RegiConnectionString %>" SelectCommand="SELECT [bookid], [bookname], [authorname], [isbnnumber], [booktype], [price] FROM [BOOK] WHERE ([available] = @available)">
                <SelectParameters>
                    <asp:Parameter DefaultValue="yes" Name="available" Type="String" />
                </SelectParameters>
            </asp:SqlDataSource>
            <asp:Label ID="Label3" runat="server" Text="AVAILABLE BOOKS" style="position:absolute; top: 181px; left: 602px;" Font-Size="Large"></asp:Label>
            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" BackColor="#CCCCCC" BorderColor="#999999" BorderStyle="Solid" BorderWidth="3px" CellPadding="4" CellSpacing="2" DataKeyNames="bookid" DataSourceID="SqlDataSource1" ForeColor="Black" style="position:absolute; top: 230px; left: 453px;">
                <Columns>
