<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="returnbookentry.aspx.cs" Inherits="library.returnbookentry" %>
...
<body style="height:657px; width:1366px;margin:0px;background-image:url('returnbookup.png'); background-repeat:no-repeat; background-size:100% 100%;">
    <form id="form1" runat="server">
      ...
      <asp:Panel CssClass="panel" ID="Panel1" runat="server" style="position:absolute; top: 127px; left: 292px; width: 834px; height: 437px;border:solid black;">
          <asp:Label ID="Label3" runat="server" Text="RETURN BOOKS" style="position:absolute; top: 20px; left: 362px;" Font-Size="X-Large"></asp:Label>
          ...
          <asp:TextBox ID="customername" runat="server" CssClass="textbox" style="position:absolute; top: 199px; left: 615px;" ToolTip="Enter Customer name"></asp:TextBox>
          <asp:TextBox ID="issuedon" runat="server" CssClass="textbox" style="position:absolute; top: 240px; left: 615px;" ToolTip="Enter Contact NO"></asp:TextBox>
          <asp:TextBox ID="returnid" runat="server" CssClass="textbox" style="position:absolute; top: 287px; left: 613px;" ToolTip="Enter Address"></asp:TextBox>
          <asp:Label ID="Label13" runat="server" Font-Size="Large" style="position:absolute; top: 289px; left: 437px; right: 239px;" Text="RETURN ID:"></asp:Label>
          <asp:Label ID="Label11" runat="server" Font-Size="Large" style="position:absolute; top: 241px; left: 439px; right: 230px;" Text="ISSUED ON:"></asp:Label>
          <asp:Label ID="Label10" runat="server" Font-Size="Large" style="position:absolute; top: 199px; left: 440px; right: 231px;" Text="CUSTOMER NAME:"></asp:Label>
          ...
          <asp:Button ID="check" runat="server" OnClick="check_Click" style="position:absolute; top: 135px; left: 162px;" Text="Check" />
          ...
          <asp:Label ID="Label14" runat="server" Font-Size="Large" style="position:absolute; top: 340px; left: 437px; right: 239px;" Text="DATE OF RETURN:"></asp:Label>
          <asp:TextBox ID="returndate" runat="server" CssClass="textbox" style="position:absolute; top: 338px; left: 613px;" ToolTip="Enter Address" TextMode="Date"></asp:TextBox>
          <asp:Button ID="checkissue" runat="server" style="position:absolute; top: 135px; left: 566px;" Text="Check" OnClick="checkissue_Click" />      
          <asp:SqlDataSource ID="SqlDataSource3" runat="server" ConnectionString="<%$ ConnectionStrings:RegiConnectionString %>" SelectCommand="SELECT * FROM [returnbook]"></asp:SqlDataSource>
      </asp:Panel>
